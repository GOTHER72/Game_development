...
void rectangle_change_1(){
	...
	case 1 :	obstacle_math_y += speed;
				if (obstacle_math_y +60 > frame_height || obstacle_math_y < 5 ) 
				{
					speed = -speed;
					game_point+=1;
	...
	case 2 :	obstacle_eee_y += speed;
				if (obstacle_eee_y +60 > frame_height || obstacle_eee_y   < 5 ) 
				{
					speed = -speed;
					game_point+=1;
				} 
	...
	case 3 :	obstacle_cse1205_y += speed;
				if (obstacle_cse1205_y +60 > frame_height || obstacle_cse1205_y   < 5 ) 
				{
					speed = -speed;
					game_point+=1;
				} 
	...
	case 4: 	obstacle_cse1203_y += speed;
				if (obstacle_cse1203_y +60 > frame_height || obstacle_cse1203_y  < 5 ) 
				{
					speed = -speed;
					game_point+=1;
				} 
	...
	case 5:   	obstacle_me_y += speed;
				if (obstacle_me_y +60 > frame_height || obstacle_me_y  < 5 ) 
				{
					speed = -speed;
					game_point+=1;
				} 
